    ...
    where W: Write
{
    ...
    //   }
    //
    fn serialize_seq_elt<T>(&mut self, v: T) -> Result<(), Error>
        where T: ser::Serialize
    {
    ...
    fn serialize_tuple_variant<V: ser::SeqVisitor>(&mut self,
                                                   _name: &'static str,
                                                   _variant_index: usize,
                                                   variant: &'static str,
                                                   mut visitor: V)
    ...
    fn serialize_struct_variant<V: ser::MapVisitor>(&mut self,
                                                    _name: &'static str,
                                                    _variant_index: usize,
                                                    variant: &'static str,
                                                    mut visitor: V)
